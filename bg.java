...
public class bg extends World
{
            ...
            public bg()
            {
                ...
                super(600, 400, 1);
                setPaintOrder(Counter.class,player.
                class, skor.class, tembok.class, ball.class);
            ...
            public void act(){
                ...
                { //menggunakan tombol spasi untuk menghentikan semenatara game
                    Greenfoot.stop();
                }
            }
            public void tambah(){
            ...
            /**
             * Called when display is up. Stop running and display score.
             */
            public void selesai()
            {
                addObject(new skor(counter.getValue()), getWidth()/2, getHeight()/2);
                //menampilkan pesan "Game Over dan skor terakhir yang diperoleh"
            }
            
            /**
             * Prepare the world for the start of the progam. That is: create the initial
